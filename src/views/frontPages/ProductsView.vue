<template>
  ...
  <VueLoading
    ...
    <!-- toast -->
    <toastMessage ref="toastMsg"></toastMessage>
...
import toastMessage from '../../components/MessageComponent.vue';
  ...
  methods: {
    ...
    addToCart(product, qty = 1) {
      ...
      this.$http
        ...
        .then(() => {
          this.$refs.toastMsg.toast_Show(message);
          // alert('已加入購物車', res); // eslint-disable-line no-alert
